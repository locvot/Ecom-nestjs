  ...
  <Html>
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Heading style={secondary}>Input your OTP please</Heading>
        <Section style={codeContainer}>
          <Text style={code}>{otpCode}</Text>
        </Section>
        <Text style={paragraph}>If you're not the one request OTP, ignore this email please</Text>
      </Container>
      <Text style={footer}>From Loc with ❤️.</Text>
    </Body>
  </Html>
)
